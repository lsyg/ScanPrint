...
public class ConexaoMySql {
    ...
    private String mensagem = "Conexão Realizada Com Sucesso";   //variavel que vai informar o status da conexao
    private Connection con = null;  //variavel para conexao
    private Statement statement;
    private ResultSet resultSet;

    private String servidor = "192.168.0.20";
    private String nomeDoBanco = "scanprint";
    private String usuario = "admin";
    private String senha = "simionato";
